...
struct CourseSection: Identifiable {
    ...
    var courseSections = [
        CourseSection(title: "Advanced Custom Layout", subtitle: "SwiftUI for iOS 15", text: "Build an iOS app for iOS 15 with custom layouts, animations and ...", image: "Illustration 1", background: "Background 5", logo: "Logo 2", progress: 0.5),
